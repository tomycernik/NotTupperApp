...
@Component({
  ...
  template: `
    <nav class="navbar">
      ...
      <div class="navbar__actions">
        @if (auth.isLogged()) {
          <span class="navbar__user">{{ auth.user()?.nombre }}</span>
  ...
  styles: [`
    ...
    .navbar__brand {
      ...
      letter-spacing: 0.06em; text-decoration: none; flex-shrink: 0;
    }
    ...
    .navbar__links a {
      ...
      color: #9a9080; transition: color 0.2s, background 0.2s;
    ...
    .navbar__user {
      font-weight: 700; font-size: 0.85rem; color: #9a9080;
      padding: 0 4px;
    }
    ...
    .navbar__burger span {
      ...
      background: #f0ece0; border-radius: 1px; transition: 0.2s;
    }
    ...
    .mobile-menu a, .mobile-menu button {
      ...
      color: #f0ece0; background: none; border: none;
